        ...
        admissions.forEach(a => {
          admissionBody.innerHTML += `
            <tr>
              ...
              <td><a href="${a.childImageUrl}" target="_blank">View Child</a></td>
              <td><a href="${a.fatherImageUrl}" target="_blank">View Father</a></td>
              <td><a href="${a.motherImageUrl}" target="_blank">View Mother</a></td>
              <td>${a.paymentStatus || ""}</td>
              <td>${a.transactionId || ""}</td>
              <td><a href="${a.paymentProofUrl}" target="_blank">View Proof</a></td>
            </tr>`;
        });
      }
    } catch (err) {
